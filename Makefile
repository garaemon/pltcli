...
all: docs/images/cos.png docs/images/inv_cos.png docs/images/inv_cos2.png docs/images/sin.png docs/images/sin_cos.png documents docs/images/cos_sin_from_one_file.png docs/images/cos_sin_from_one_file_one_arg.png
...
docs/images/cos_sin_from_one_file_one_arg.png: $(PLTCLI) sample_data/cos_sin.csv
	$(PLTCLI) sample_data/cos_sin.csv[x:cos,x:sin] -o $@
